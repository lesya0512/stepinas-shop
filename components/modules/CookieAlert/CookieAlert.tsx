...
const CookieAlert = ({
    ...
    const handleAcceptCookie = () => {
        document.cookie = 'CookieBy=Stepinas; max-age=' + 60 * 60 * 24 * 30
    ...
    <div className='container cookie-popup__container'>
        ...
        <p
            ...
            dangerouslySetInnerHTML={{
                __html: 'Используя данный сайт, вы даете согласие на использование файлов cookie, помогающих нам сделать его удобнее для вас.',
            }}
        />
        <button
